...
public class DeclareFunExpr extends Statement implements ComplexExpr {

  private String _name;
  private List<Integer> _sizes;
  private List<Expr> _subExpressions;

  public DeclareFunExpr(String name, List<Integer> sizes) {
    _name = name;
    _sizes = sizes;
    _subExpressions = new ArrayList<>();
    _subExpressions.add(new IdExpr("declare-fun"));
